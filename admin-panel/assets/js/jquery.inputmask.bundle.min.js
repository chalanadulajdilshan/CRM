        ...
        !(function(o) {
            ...
            function s(t, n) {
                function r(t, r, o) {
                    var s = !1;
                    if (
                        ((null !== t && "" !== t) || ((s = null !== o.regex) ? (t = (t = o.regex).replace(/^(\^)(.*)(\$)$/, "$2")) : ((s = !0), (t = ".*"))),
                    ...
                    return (
                        ...
                        ((c = { mask: t, maskToken: i.prototype.analyseMask(t, s, o), validPositions: {}, _buffer: a, buffer: a, tests: {}, metadata: r, maskLength: a }), !0 !== n && ((i.prototype.masksCache[u] = c), (c = e.extend(!0, {}, i.prototype.masksCache[u])))) :
            ...
            function l(r, s, c) {
                function m(e, t, n) {
                    ...
                    do {
                        !0 === e && h().validPositions[l] ?
                            ((r = (o = h().validPositions[l]).match), (i = o.locator.slice()), s.push(!0 === n ? o.input : !1 === n ? r.nativeDef : I(l, r))) :
                            ((r = (o = b(l, i, l - 1)).match),
                                (i = o.locator.slice()),
                                (!1 === c.jitMasking || l < u || ("number" == typeof c.jitMasking && isFinite(c.jitMasking) && c.jitMasking > l)) && s.push(!1 === n ? r.nativeDef : I(l, r))),
                            l++;
                    ...
                    for (g(!0), o = s + 1; o <= v();) {
                        ...
                        if ((o < s && (o = s + 1), h().validPositions[o] === a && M(o))) o++;
                            ...
                            !1 === u && l[s] && l[s].match.def === p.match.def ?
                                ((h().validPositions[s] = e.extend(!0, {}, l[s])), (h().validPositions[s].input = p.input), delete h().validPositions[o], o++) :
                                P(s, p.match.def) ?
                ...
                function k(e, t) {
                    for (
                        var n, i = e, r = v(), o = h().validPositions[r] || S(0)[0], s = o.alternation !== a ? o.locator[o.alternation].toString().split(",") : [], l = 0; l < i.length &&
                        (!(
                                (n = i[l]).match &&
                                ((c.greedy && !0 !== n.match.optionalQuantifier) || ((!1 === n.match.optionality || !1 === n.match.newBlockMarker) && !0 !== n.match.optionalQuantifier)) &&
                                (o.alternation === a || o.alternation !== n.alternation || (n.locator[o.alternation] !== a && O(n.locator[o.alternation].toString().split(","), s)))
                            ) ||
                            (!0 === t && (null !== n.match.fn || /[0-9a-bA-Z]/.test(n.match.def)))); l++
                    );
                    return n;
                }
                ...
                function S(t, n, i) {
                                                    ...
                                                    if ("string" != typeof A || -1 !== e.inArray(j.locator[j.alternation].toString(), R)) {
                                                        if (
                                                            ...
                                                            j.alternation === F.alternation &&
                                                                ...
                                                                ((F.locator[F.alternation] = F.locator[F.alternation] + "," + j.locator[j.alternation]), (F.alternation = j.alternation)),
                                                                j.match.nativeDef === F.match.def && ((j.locator[j.alternation] = F.locator[F.alternation]), P.splice(P.indexOf(F), 1, j));
                                                            break;
                                                        }
                                                        ...
                                                        if (
                                                            ...
                                                            j.alternation === F.alternation &&
                                                                -1 === j.locator[j.alternation].toString().indexOf(F.locator[F.alternation].toString().split("")[0]) &&
                                                                ((j.na = j.na || j.locator[j.alternation].toString()), -1 === j.na.indexOf(j.locator[j.alternation].toString().split("")[0]) && (j.na = j.na + "," + j.locator[F.alternation].toString().split("")[0]),
                                                                    (N = !0),
                                                                    (j.locator[j.alternation] = F.locator[F.alternation].toString().split("")[0] + "," + j.locator[j.alternation]),
                    ...
                    return (
                        (0 === f.length || d) && f.push({ match: { fn: null, cardinality: 0, optionality: !0, casing: null, def: "", placeholder: "" }, locator: [], cd: m }),
                    ...
                    function d(t) {
                        ...
                        for (n++; n < t; n++)
                            ...
                            ("" === (r = S(n, b(n - 1).locator, n - 1).slice())[r.length - 1].match.def && r.pop(),
                                (i = k(r)) &&
                                (i.match.def === c.radixPointDefinitionSymbol || !M(n, !0) || (e.inArray(c.radixPoint, A()) < n && i.match.fn && i.match.fn.test(I(n), h(), n, !1, c))) &&
                                !1 !== (x = p(n, I(n, i.match, !0) || (null == i.match.fn ? i.match.def : "" !== I(n) ? I(n) : A()[n]), !0)) &&
                                                    ...
                                                    for (var r = i.locator, o = r.length, s = t; s < n; s++)
                                                        if (h().validPositions[s] === a && !M(s, !0)) {
                                                            ...
                                                            "" === l[l.length - 1].match.def && l.pop(),
                                                                ...
                                                                ((c = e.extend({}, c, { input: I(s, c.match, !0) || c.match.def })).generatedInput = !0),
                                                                f(s, c, !0),
                                                                (h().validPositions[n] = a),
                                                                p(n, i.input, !0);
                                                        }
                ...
                function N(t, n, i, r, o) {
                    ...
                    t !== a &&
                        (t.inputmask._valueSet(n.join("")),
                            ...
                            G(t, i), !0 === o && ((X = !0), e(t).trigger("input")));
                }
                        ...
                        if (t > -1 && h().validPositions[t] === a) {
                            ...
                            if (o.length > 1 + ("" === o[o.length - 1].match.def ? 1 : 0))
                                for (var l = 0; l < o.length; l++)
                                    if (!0 !== o[l].match.optionality &&
                                        !0 !== o[l].match.optionalQuantifier &&
                                        (null === o[l].match.fn || r === a || !1 !== o[l].match.fn.test(r.match.def, h(), t, !0, c)) &&
                                        (s.push(o[l]), null === o[l].match.fn && (r = o[l]), s.length > 1 && /[0-9a-bA-Z]/.test(s[0].match.def))
                                    )
                ...
                function G(e, i, r, o) {
                    ...
                    if (i === a)
                        return (
                            ...
                            t.getSelection ?
                            ((l = t.getSelection().getRangeAt(0)).commonAncestorContainer.parentNode !== e && l.commonAncestorContainer !== e) || ((i = l.startOffset), (r = l.endOffset)) :
                            n.selection && n.selection.createRange && (r = (i = 0 - (l = n.selection.createRange()).duplicate().moveStart("character", -e.inputmask._valueGet().length)) + l.text.length), { begin: s(i), end: s(r) }
                        );
                        ...
                        ((i = l[n]).match.optionality ||
                            ...
                            (p &&
                                ((p !== l[n].locator[c.alternation] && null != i.match.fn) ||
                                    (null === i.match.fn && i.locator[c.alternation] && O(i.locator[c.alternation].toString().split(","), p.toString().split(",")) && "" !== S(n)[0].def)))) &&
                        r[n] === I(n, i.match); n--
                    )
                        o--;
                ...
                function L(e) {
                    for (
                        var t, n = B(), i = e.length, r = h().validPositions[v()]; n < i &&
                        !M(n, !0) &&
                        (t = r !== a ? b(n, r.locator.slice(""), r) : x(n)) &&
                        !0 !== t.match.optionality &&
                        ((!0 !== t.match.optionalQuantifier && !0 !== t.match.newBlockMarker) || (n + 1 === i && "" === (r !== a ? b(n + 1, r.locator.slice(""), r) : x(n + 1)).match.def));
                ...
                function V(t, n, r, o, s) {
                    ...
                    n === i.keyCode.BACKSPACE && (r.end - r.begin < 1 || !1 === c.insertMode) ?
                        ((r.begin = D(r.begin)), h().validPositions[r.begin] !== a && h().validPositions[r.begin].input === c.groupSeparator && r.begin--) :
                        n === i.keyCode.DELETE &&
                        r.begin === r.end &&
                        ((r.end = M(r.end, !0) && h().validPositions[r.end] && h().validPositions[r.end].input !== c.radixPoint ? r.end + 1 : _(r.end) + 1),
                            h().validPositions[r.begin] !== a && h().validPositions[r.begin].input === c.groupSeparator && r.end++),
                        y(r.begin, r.end, !1, o), !0 !== o &&
                        (function() {
                            if (c.keepStatic) {
                            ...
                            do {
                                o(),
                                    ...
                                    ((l = b(d, u, d - 1)),
                                        (s = l.match),
                                        (u = l.locator.slice()),
                                        (!1 === c.jitMasking || d < g || ("number" == typeof c.jitMasking && isFinite(c.jitMasking) && c.jitMasking > d)) && (r(), (p += I(d, s)))),
                                    d++;
                            ...
                            var o = function(t) {
                                if (this.inputmask === a && "FORM" !== this.nodeName) {
                                    ...
                                    if (
                                        "setvalue" === t.type ||
                                        "FORM" === this.nodeName ||
                                        !(this.disabled || (this.readOnly && !(("keydown" === t.type && t.ctrlKey && 67 === t.keyCode) || (!1 === c.tabThrough && t.keyCode === i.keyCode.TAB))))
                                    ) {
                                        switch (t.type) {
                                            case "input":
                    ...
                    ae = {
                        keydownEvent: function(t) {
                            ...
                            if (
                                ...
                                t.preventDefault(), V(a, o, s), N(a, A(!0), h().p, t, a.inputmask._valueGet() !== A().join("")), a.inputmask._valueGet() === w().join("") ? r.trigger("cleared") : !0 === U(A()) && r.trigger("complete");
                                ...
                                (!0 === t.shiftKey ?
                                    (null === x(s.begin).match.fn && (s.begin = _(s.begin)), (s.end = D(s.begin, !0)), (s.begin = D(s.end, !0))) :
                                ...
                                ((c.insertMode = !c.insertMode), G(a, c.insertMode || s.begin !== h().maskLength ? s.begin : s.begin - 1));
                        ...
                        keypressEvent: function(t, n, r, o, s) {
                            ...
                            if (p) {
                                ...
                                var v = R(d, m, o);
                                if (
                                    (!1 !== v && (g(!0), (f = v.caret !== a ? v.caret : n ? v.pos + 1 : _(v.pos)), (h().p = f)), !1 !== r &&
                                        (setTimeout(function() {
                                    ...
                                    var y = A();
                                    N(l, y, c.numericInput && v.caret === a ? D(f) : f, t, !0 !== n), !0 !== n &&
                                        setTimeout(function() {
                        ...
                        inputFallBackEvent: function(t) {
                            ...
                            if (A().join("") !== a) {
                                ...
                                if (!1 ===
                                    (function(t, n, a) {
                                        if (
                                            ("." === n.charAt(a.begin - 1) && "" !== c.radixPoint && (((n = n.split(""))[a.begin - 1] = c.radixPoint.charAt(0)), (n = n.join(""))),
                                    ...
                                    return !1;
                                if (
                                    ((a = a.replace(new RegExp("(" + i.escapeRegex(w().join("")) + ")*"), "")), !1 ===
                                        (function(t, n, a) {
                                            if (p) {
                                ...
                                l !== f && (l.length > f.length ? g && (d.end = d.begin) : l.length < f.length ? (d.end += f.length - l.length) : l.charAt(0) !== f.charAt(0) && d.end++),
                                    N(n, A(), d),
                                    m.length > 0 ?
                                    ...
                                    (d.begin === d.end - 1 && G(n, D(d.begin + 1), d.end), (t.keyCode = i.keyCode.DELETE), ae.keydownEvent.call(n, t)),
                                    t.preventDefault();
                            }
                        },
                        ...
                        focusEvent: function(e) {
                            ...
                            c.showMaskOnFocus && (!c.showMaskOnHover || (c.showMaskOnHover && "" === n)) && (t.inputmask._valueGet() !== A().join("") ? N(t, A(), _(v())) : !1 === te && G(t, _(v()))), !0 === c.positionCaretOnTab && !1 === te && "" !== n && (N(t, A(), G(t)), ae.clickEvent.apply(t, [e, !0])),
                                (z = A().join(""));
                        },
                        ...
                        blurEvent: function(t) {
                            ...
                            if (i.inputmask) {
                                var r = i.inputmask._valueGet(),
                                    o = A().slice();
                                "" !== r &&
                                    (c.clearMaskOnLostFocus && (-1 === v() && r === w().join("") ? (o = []) : L(o)), !1 === U(o) &&
                                        (setTimeout(function() {
                        ...
                        submitEvent: function(e) {
                            z !== A().join("") && q.trigger("change"),
                                c.clearMaskOnLostFocus && -1 === v() && Y.inputmask._valueGet && Y.inputmask._valueGet() === w().join("") && Y.inputmask._valueSet(""),
                    ...
                    switch (r.action) {
                        ...
                        case "mask":
                            !(function(t) {
                                ...
                                if (!1 !== i &&
                                    ((Y = t),
                                        (q = e(Y)), -1 === (Q = Y !== a ? Y.maxLength : a) && (Q = a), !0 === c.colorMask && K(Y),
                                        d && (Y.hasOwnProperty("inputmode") && ((Y.inputmode = c.inputmode), Y.setAttribute("inputmode", c.inputmode)), "rtfm" === c.androidHack && (!0 !== c.colorMask && K(Y), (Y.type = "password"))), !0 === i &&
                                        (ne.on(Y, "submit", ae.submitEvent),
                                            ...
                                            ne.on(Y, "mouseleave", ae.mouseleaveEvent), !0 !== c.colorMask && ne.on(Y, "click", ae.clickEvent),
                                            ...
                                            d || !0 === c.inputEventOnly ? Y.removeAttribute("maxLength") : (ne.on(Y, "keydown", ae.keydownEvent), ne.on(Y, "keypress", ae.keypressEvent)),
                        ...
                        case "format":
                            return (
                                ...
                                r.metadata ? { value: Z ? A().slice().reverse().join("") : A().join(""), metadata: l.call(this, { action: "getmetadata" }, s, c) } : Z ? A().slice().reverse().join("") : A().join("")
                            );
                        case "isValid":
                        ...
                        case "remove":
                            if (Y && Y.inputmask) {
                                ...
                                Object.getOwnPropertyDescriptor && Object.getPrototypeOf ?
                                    ...
                                    Object.defineProperty(Y, "value", { get: Y.inputmask.__valueGet, set: Y.inputmask.__valueSet, configurable: !0 }) :
                                    n.__lookupGetter__ && Y.__lookupGetter__("value") && Y.inputmask.__valueGet && (Y.__defineGetter__("value", Y.inputmask.__valueGet), Y.__defineSetter__("value", Y.inputmask.__valueSet)),
                                    (Y.inputmask = a);
                            }
                            return Y;
                        case "getmetadata":
                ...
                (i.prototype = {
                    ...
                    analyseMask: function(t, n, r) {
                        ...
                        var p,
                            ...
                            P = [],
                            S = [];
                        for (n && ((r.optionalmarker.start = a), (r.optionalmarker.end = a));
                                ...
                                switch (f.charAt(0)) {
                                    ...
                                    case r.quantifiermarker.start:
                                        ...
                                        if ((("*" !== O && "+" !== O) || (C = "*" === O ? 0 : 1), (A.quantifier = { min: C, max: O }), P.length > 0)) {
                                            ...
                                            (p = x.matches.pop()).isGroup || (n && null === p.fn && "." === p.def && (p.fn = new RegExp(p.def, r.casing ? "i" : "")), (v = new o(!0)).matches.push(p), (p = v)),
                                            x.matches.push(p),
                                            x.matches.push(A);
                                        break;
                        ...
                        definitions: {
                            1: {
                                validator: function(e, t, n, a, i) {
                                    ...
                                    return a || r || (e.charAt(1) !== i.separator && -1 === "-./".indexOf(e.charAt(1))) || !(r = i.regex.val1.test("0" + e.charAt(0))) ?
                                        r :
                            ...
                            2: {
                                validator: function(e, t, n, a, i) {
                                    ...
                                    return a || o || (e.charAt(1) !== i.separator && -1 === "-./".indexOf(e.charAt(1))) || !(o = i.regex.val2(i.separator).test(r + "0" + e.charAt(0))) ?
                                        o :
                                        ((t.buffer[n - 1] = "0"), { refreshFromBuffer: { start: n - 1, end: n }, pos: n, c: e.charAt(0) });
                                },
                                cardinality: 2,
                                prevalidator: [{
                                    validator: function(e, t, n, a, i) {
                                        ...
                                        return (
                                            o && t.validPositions[n] && (i.regex.val2(i.separator).test(e + t.validPositions[n].input) || (t.validPositions[n].input = "0" === e ? "1" : "0")),
                                            a || o || !(o = i.regex.val2(i.separator).test(r + "0" + e)) ? o : ((t.buffer[n] = "0"), n++, { pos: n })
                                        );
                                    },
                                    cardinality: 1,
                                }, ],
                                    ...
                                    },
                                    {
                                        validator: function(e, t, n, a, i) {
                                            ...
                                            if (!a && !r) {
                                                ...
                                                if (((o = i.determinebaseyear(i.yearrange.minyear, i.yearrange.maxyear, e).toString().slice(0, 2)), (r = i.isInYearRange(o + e, i.yearrange.minyear, i.yearrange.maxyear))))
                                                    return (t.buffer[n - 1] = o.charAt(0)), (t.buffer[n++] = o.charAt(1)), (t.buffer[n++] = e.charAt(0)), { refreshFromBuffer: { start: n - 3, end: n }, pos: n };
                                            }
                                            return r;
                                        },
                                        cardinality: 2,
                        ...
                        definitions: {
                            h: {
                                validator: function(e, t, n, a, i) {
                                    ...
                                    if (!a && !r && (e.charAt(1) === i.timeseparator || -1 !== "-.:".indexOf(e.charAt(1))) && (r = i.regex.hrs.test("0" + e.charAt(0))))
                                        return (t.buffer[n - 1] = "0"), (t.buffer[n] = e.charAt(0)), n++, { refreshFromBuffer: { start: n - 2, end: n }, pos: n, c: i.timeseparator };
                                    if (r && "24" !== i.hourFormat && i.regex.hrs24.test(e)) {
                                        var o = parseInt(e, 10);
                                        return (
                                            24 === o ? ((t.buffer[n + 5] = "a"), (t.buffer[n + 6] = "m")) : ((t.buffer[n + 5] = "p"), (t.buffer[n + 6] = "m")),
                                            (o -= 12) < 10 ? ((t.buffer[n] = o.toString()), (t.buffer[n - 1] = "0")) : ((t.buffer[n] = o.toString().charAt(1)), (t.buffer[n - 1] = o.toString().charAt(0))), { refreshFromBuffer: { start: n - 1, end: n + 6 }, c: t.buffer[n] }
                                        );
                                    }
                                    return r;
                                },
                    ...
                    numeric: {
                        mask: function(e) {
                            ...
                            e.placeholder.length > 1 && (e.placeholder = e.placeholder.charAt(0)),
                                ...
                                (e.definitions[";"].definitionSymbol = "~"), !0 === e.numericInput &&
                            ...
                            if (((r += a(e.prefix, e)), !0 === e.integerOptional ? (r += "~{1," + e.integerDigits + "}") : (r += "~{" + e.integerDigits + "}"), e.digits !== n)) {
                                ...
                                isFinite(o[0] && o[1] && isFinite(o[1])) ?
                                    ...
                                    (isNaN(e.digits) || parseInt(e.digits) > 0) && (e.digitsOptional ? (r += "[" + e.radixPointDefinitionSymbol + ";{1," + e.digits + "}]") : (r += e.radixPointDefinitionSymbol + ";{" + e.digits + "}"));
                            }
                        ...
                        postValidation: function(a, i, r) {
                            ...
                            u !== n &&
                                ...
                                ((c[l] = "?"),
                                    ...
                                    r.suffix.length > 0 && l >= c.length - r.suffix.length - (!1 === r.isNegative ? 1 : 0) && (o[l - (c.length - r.suffix.length - (!1 === r.isNegative ? 1 : 0))] = "?")),
                                (s = s.join("")),
                                (o = o.join(""));
                            ...
                            if (
                                ((p = p.replace(o, "")),
                                    ...
                                    p.length > 1 && 1 !== p.indexOf(r.radixPoint) && ("0" === u && (p = p.replace(/^\?/g, "")), (p = p.replace(/^0/g, ""))),
                                ...
                                if (((p = p.split("")), (!r.digitsOptional || (r.enforceDigitsOnBlur && "blur" === i.event)) && isFinite(r.digits))) {
                                    ...
                                    for (var m = 1; m <= r.digits; m++)
                                        (r.digitsOptional && (!r.enforceDigitsOnBlur || "blur" !== i.event)) || (p[f + m] !== n && p[f + m] !== r.placeholder.charAt(0)) ?
                                ...
                                if (!0 !== r.autoGroup || "" === r.groupSeparator || (u === r.radixPoint && i.pos === n && !i.dopost)) p = p.join("");
                                    ...
                                    (p = t(
                                        (function(e, t) {
                                            ...
                                            return n;
                                        })(p, r), { numericInput: !0, jitMasking: !0, definitions: { "*": { validator: "[0-9?]", cardinality: 1 } } }
                                    ).format(p.join(""))),
                                    h && (p += r.radixPoint),
                                ...
                                switch (a.type) {
                                    ...
                                    case "checkval":
                                        ...
                                        if (
                                            ...
                                            if (((s = o.onUnMask(i.join(""), n, e.extend({}, o, { unmaskAsNumber: !0 }))), null !== o.min && s < o.min))
                                                return (o.isNegative = o.min < 0), o.postValidation(o.min.toString().replace(".", o.radixPoint).split(""), { caret: r, dopost: !0, placeholder: "0" }, o);
                                            if (null !== o.max && s > o.max) return (o.isNegative = o.max < 0), o.postValidation(o.max.toString().replace(".", o.radixPoint).split(""), { caret: r, dopost: !0, placeholder: "0" }, o);
                                        }
                        ...
                        onUnMask: function(e, n, a) {
                            ...
                            return (
                                ...
                                a.unmaskAsNumber ?
                                ("" !== a.radixPoint && -1 !== i.indexOf(a.radixPoint) && (i = i.replace(t.escapeRegex.call(this, a.radixPoint), ".")),
                        ...
                        onBeforeMask: function(e, a) {
                            ...
                            if (
                                ((e =
                                    ...
                                    0 === a.digits && (-1 !== e.indexOf(".") ? (e = e.substring(0, e.indexOf("."))) : -1 !== e.indexOf(",") && (e = e.substring(0, e.indexOf(",")))),
        ...
        !(function(o) {
            ...
            return (
                (t.prototype.analyseMask = function(t, n, i) {
                    ...
                    var s = {};
                    return (
                        i.phoneCodes && (i.phoneCodes && i.phoneCodes.length > 1e3 && (r((t = t.substr(1, t.length - 2)).split(i.groupmarker.end + i.alternatormarker + i.groupmarker.start)), (t = o(s))), (t = t.replace(/9/g, "\\9"))),
                        a.call(this, t, n, i)
                    );
                }),
                t.extendAliases({
